  ...
  return (
    <div id="about-anchor" className="about-container">
      ...
      <div className="about-page-text">
        ...
        <br />
        <p>
          I love working with APIs, from building them to integrating them with
          my projects. I recently worked on the open source Numbers API. The
          most impactful undertaking I did for the Numbers API was building
          several <strong>GraphQL</strong> endpoints using the{" "}
          <strong>Apollo</strong> library. We sanitized and retrieved the data
          required for the endpoints using the existing data layer, which was a
          huge win!
        </p>
        {/* <br />
          <p>
